module.exports = {
  ...
  About: "About",
  IndexAboutInfo:
    "PolkaProject индекс (PPI) - это взешенный по капитализации индекс отслеживающий эффективность децентрализованных финансовых активов в целом по рынку.",
  Back: "Назад",
  ...
  Yourpartnership: "Ваш partnership",
  Subscribe: "Подписаться",
  SubmitThisProject: "Добавить обновление по этому проекту",
  projectAboutInfo:
    "Информация на этом сайте представлена исключительно в образовательных целях и должна использоваться только для ваших личных исследованиях. Мы не даем рекомендаций по инвестициям, не поддерживаем определенный проект или подход, и не обещаем вам какой-либо результат.",
  D: "1Д",
  W: "1Н",
  M: "1М",
  Y: "1Г",
  ...
  NoResultsInfo:
    "Подсказка: <br>Пожалуйста, убедитесь, что все слова написаны правильно. <br> Пожалуйста, попробуйте другое ключевое слово. <br> Пожалуйста, попробуйте расширить диапазон словосочетаний.",
  NoMore: "No More",
  Title: "Заголовок",
  ...
  PLOTokenAllocationPlan:
    "Ссылка на официальный анонс Плана по распределению токенов на PLO (предложение по аренде слота парачейна)",
  Submit: "Добавить",
